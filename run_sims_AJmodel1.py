...
def run_sim(parameters,case,length,total,chr_number):
...
def main():
	...
	for chr_number in range(1,chr+1):
		...
		while flag_sim==False:
			...
			sim=run_sim(parameters,case,length,total,chr_number)
