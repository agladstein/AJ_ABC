	...
	for chr_number in range(1,chr+1):
		...
		while flag_sim==False:
			...
			for i in xrange(nbss):
				position=round(sim.getPosition(i)*(length))#you have to give the number of the snp
				pos.append(position)
