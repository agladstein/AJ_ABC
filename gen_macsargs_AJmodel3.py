...
def main():
    ...
    macs_args_test = run_sim_M3_inst.run_sim(parameters, 100, 1, total, total_naf, total_nas, total_neu, nJ, nM, nEA, nWA, seed_option)
    ...
    for chr, length in enumerate(lengths, start=1):
        ...
        macs_args = run_sim_M3_inst.run_sim(parameters, length, chr, total, total_naf, total_nas, total_neu, nJ, nM, nEA, nWA, seed_option)
        out_file.write('macs_args_{}:{}\n'.format(chr,macs_args))

    print 'gen_macsargs_AJmodel3.py Completed'
