...
iput -K -f ${OUT_PATH}/sim_values_AJ_M${MODEL}/${SIM} /iplant/home/agladstein/AJmacs_data/macsSwig_AJmodels_instant/sim_values_AJ_M${MODEL}/${PBS_ID}

echo 'iroding ' ${RESULTS}
imkdir -p /iplant/home/agladstein/AJmacs_data/macsSwig_AJmodels_instant/results_sims_AJ_M${MODEL}/${PBS_ID}
iput -K -f ${OUT_PATH}/results_sims_AJ_M${MODEL}/${RESULTS} /iplant/home/agladstein/AJmacs_data/macsSwig_AJmodels_instant/results_sims_AJ_M${MODEL}/${PBS_ID}
